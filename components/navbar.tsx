          ...
          <div className="w-full max-w-[1500px] relative z-[9991]">
            ...
            <div className="flex items-center justify-between w-full h-16 px-4">
              ...
              <div className="flex items-center gap-4 flex-1 lg:max-w-[800px]">
                ...
                {/* Logo */}
                <NavbarBrand as="li" className="lg:relative lg:left-0 lg:transform-none lg:mr-6 flex-shrink-0 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:top-auto lg:translate-x-0 lg:translate-y-0">
                  <motion.div
                ...
                {/* Desktop Search Bar */}
                <div className="hidden lg:block flex-1 max-w-[500px]" ref={searchContainerRef}>
                  ...
                  {siteConfig.navItems
                    ...
                    .map((item) => (
                      <NextLink
                        key={item.href}
                        href={item.href}
                        className="text-black text-sm font-medium hover:text-primary transition-colors whitespace-nowrap px-2"
                      >
                        {item.label}
                      </NextLink>
                    ))}
